      ...
      <div class="container">
        ...
        <nav aria-label="breadcrumb" >
          <ol class="breadcrumb" style="background-color: #fbedf6;">
            ...
            <li class="breadcrumb-item active" aria-current="page">Menyusui</li>
          </ol>
        </nav>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="<?php echo base_url().'/uploads/'.$art->gambar ?>" class="img-fluid mb-4" alt="...">
                ...
                <h3 style="font-size:16px; font-family: Poppins;"><a href="<?php echo site_url('Artikel_kami/lihat_artikel/'. $art->id_artikel); ?>"><b><?php echo $art->judul; ?></b></a></h3>
                <div class="row">
                 <div class="col-lg-6">
                ...
                <p style="font-size:14px; text-align: justify;"><?php echo $art->read_more; ?></p>
