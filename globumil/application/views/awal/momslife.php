      ...
      <div class="container">
        ...
        <nav aria-label="breadcrumb" >
          <ol class="breadcrumb" style="background-color: #fbedf6;">
            ...
            <li class="breadcrumb-item active" aria-current="page">Moms Life</li>
          </ol>
        </nav>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
           ...
           <div class="col-lg-3 col-md-6">
            <div class="count-box">
                <a href="<?php echo base_url('Artikel_kami/momslife') ?>"  class="btn" style="width: 200px; background-color: #c82a87; color: white;">Mom's Life</a>
            </div>
          </div>
